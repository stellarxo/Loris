{* This file is overwritten in order to change the title
   to be longer than the study title in the config file,
   which was shortened so that it looks better in the survey
   emails *}
...
<img src="{$study_logo}" border="0" width="64" height="57" />IBIS (Infant Brain Imaging Study) Network for Autism Research
</br>
<!--</th>
</tr>
<tr>
