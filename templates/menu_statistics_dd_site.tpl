...
<div class="table-responsive">
   <table class="table table-primary table-bordered" width="100%">
      ...
      <tr bgcolor="#FFFFFF">
         ...
         <td>{$data[item].count}  <br />(<a href="main.php?test_name=statistics_site_breakdown&instrument={$data[item].name}&CenterID={$CenterID}&ProjectID={$ProjectID}&DDE=1">View list</a>)</td>
