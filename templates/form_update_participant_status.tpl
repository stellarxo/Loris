...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                {html_options id="participant_status" options=$pstatus_options name="participant_status" selected=$pstat class="form-control input-sm"}
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-sm-4">
                {html_options id="participant_suboptions" options=$pstatus_suboptions name="participant_suboptions" selected=$pstat_sub class="form-control input-sm"}
            </div>
        </div>
        <div class="row">
