...
`informant_confidence` enum('extremely_confident','very_confident','moderately_confident','little_confident','not_confident') default NULL,
...
INSERT INTO test_names(Test_name, Full_name,Sub_group,isDirectEntry) VALUES ('pspq_father','PSPQ-Father (Personality Styles and Preferences Questionnaire)',6, true);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('pspq_father','pspq_father_page2','Respondent Page2', 1);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('pspq_father','pspq_father_page3','Respondent Page3', 2);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('pspq_father','pspq_father_page4','Informant Page1', 3);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('pspq_father','pspq_father_page5','Informant Page2', 4);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('pspq_father','pspq_father_page6','Informant Page3', 5);
